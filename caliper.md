...
| -------- |  -----  | ----------- |
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
...
| type | string | If a generic Event is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Event; otherwise the value MUST be assigned the IRI appropriate for the subclass utilized, e.g., http://purl.imsglobal.org/caliper/v1/NavigationEvent.  |
...
| Property | Type | Requirements |
| -------- | ---- | ----------- |
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context.  The context MAY be omitted if it duplicates the enclosing Event context. |
...
| type | string | If a generic Entity is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Entity; otherwise the value MUST be assigned the IRI appropriate for the subclass, e.g., http://purl.imsglobal.org/caliper/v1/Person. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/AssessmentEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/AssessmentItemEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/AssignableEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/ForumEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/MediaEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/MessageEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/NavigationEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/OutcomeEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/SessionEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/ThreadEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/ToolUseEvent |
...
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1/Context. |
| id | UUID | An id MUST be generated by the endpoint if an Event is received without an id.  The id must be in the form of a UUID in standard string form (see RFC 4122 for requirements). |
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/ViewEvent. |
...
| type | string | If a generic Agent is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Agent; otherwise the value MUST be assigned the IRI appropriate for the subclass, e.g., http://purl.imsglobal.org/caliper/v1/Person. |
...
| type | string | If a generic Annotation is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Annotation; otherwise the value MUST be assigned the IRI appropriate for the subclass, e.g., http://purl.imsglobal.org/caliper/v1/BookmarkAnnotation. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Assessment. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/AssessmentItem. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/AssignableDigitalResource. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Attempt. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/AudioObject. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/BookmarkAnnotation. |
| actor | [Person](#person) | The Person who created the Annotation MUST be specified. |
| annotated | [DigitalResource](#digitalResource) | The DigitalResource that was annotated MUST be specified.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Chapter. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Collection. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/CourseOffering. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/CourseSection. |
...
| type | string |  If a generic DigitalResource is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/DigitalResource; otherwise the value MUST be assigned the IRI appropriate for the subclass, e.g., http://purl.imsglobal.org/caliper/v1/Message.  |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Document. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/EpubChapter. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/EpubPart. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/EpubSubChapter. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/FillinBlankResponse. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Forum. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Frame. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Group. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/HighlightAnnotation. |
| actor | [Person](#person) | The Person who created the Annotation MUST be specified. |
| annotated | [DigitalResource](#digitalResource) | The DigitalResource that was annotated MUST be specified.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/ImageObject. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/LearningObjective. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/LtiSession. |
...
| type | string | If a generic MediaObject is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/MediaObject; otherwise the value MUST be assigned the IRI appropriate for the subclass, e.g., http://purl.imsglobal.org/caliper/v1/VideoObject.  |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Membership. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Message.  |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/MultipleChoiceResponse. |
| attempt | [Attempt](#attempt) | The associated Attempt MUST be specified.  The Attempt MUST reference both the Person who initiated the Response and the DigitalResource that constitutes the object of the assignment.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/MultipleResponseResponse. |
| attempt | [Attempt](#attempt) | The associated Attempt MUST be specified.  The Attempt MUST reference both the Person who initiated the Response and the DigitalResource that constitutes the object of the assignment.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Organization. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Page. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Person. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Reading. |
...
| type | string | If a generic Response is created instead of one of its subclasses, the value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Response; otherwise the value MUST be assigned the IRI appropriate for the subclass, e.g., http://purl.imsglobal.org/caliper/v1/TrueFalseResponse. |
| attempt | [Attempt](#attempt) | The associated Attempt MUST be specified.  The Attempt MUST reference both the Person who initiated the Response and the DigitalResource that constitutes the object of the assignment.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/SelectTextResponse. |
| attempt | [Attempt](#attempt) | The associated Attempt MUST be specified.  The Attempt MUST reference both the Person who initiated the Response and the DigitalResource that constitutes the object of the assignment.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Session. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/SharedAnnotation. |
| actor | [Person](#person) | The Person who created the Annotation MUST be specified. |
| annotated | [DigitalResource](#digitalResource) | The DigitalResource that was annotated MUST be specified.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/SoftwareApplication. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/TagAnnotation. |
| actor | [Person](#person) | The Person who created the Annotation MUST be specified. |
| annotated | [DigitalResource](#digitalResource) | The DigitalResource that was annotated MUST be specified.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/Thread. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/ TrueFalseResponse. |
| attempt | [Attempt](#attempt) | The associated Attempt MUST be specified.  The Attempt MUST reference both the Person who initiated the Response and the DigitalResource that constitutes the object of the assignment.  Note that DigitalResource is a generic type that is subclassed for greater type specificity.  Utilize DigitalResource only if no suitable subclass exists to represent the object. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/VideoObject. |
...
| type | string | The value MUST be assigned the IRI http://purl.imsglobal.org/caliper/v1/WebPage. |
