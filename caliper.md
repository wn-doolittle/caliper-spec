...
| -------- |  -----  | ----------- |
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1p1. |
...
| Property | Type | Requirements |
| -------- | ---- | ----------- |
| context | string | The value MUST be assigned the IRI http://purl.imsglobal.org/ctx/caliper/v1p1.  The context MAY be omitted if it duplicates the enclosing Event context. |
