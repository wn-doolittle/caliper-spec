...
## 1.0. Introduction
Delivering teaching and learning at scale is encouraging adoption of “big data” practices.  Cloud computing and machine learning are changing the learning technology landscape and the business of education.  The definition of what constitutes learning is also evolving beyond the formal classroom experience to include informal, social and experiential modes of acquiring knowledge and skills.  Opportunities exist to leverage new tools, tap new data sources, ask new questions and pursue new insights. 

Consider the instructor who utilizes a video platform to post multi-media assignments and a forums platform for hosting Q&A sessions while administering her course using a learning management system.  Three services, three vendors, three potential sources of data.  Analyzing the viewing behavior of her students in relation to the questions they pose about the video content she has posted should be a key concern.  Yet exploring such relationships is all too often a challenging exercise for instructors and researchers.  Likely there are significant barriers to overcome.  Is the data required for analysis actually collected?  If it exists, who owns it?  If ownership is not an issue what about privacy concerns?  If privacy protocols are in place is the data easy to retrieve?  If the data can be collected how difficult is it to combine with data sourced from other platforms and vendors?
