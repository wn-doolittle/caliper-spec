...
| assignee | [Person](#person) | The [Person](#person) who initiated the [Attempt](#attempt) of the `assignable` SHOULD be specified.  The `assignee` value MUST be expressed either as an object or coerced to a string corresponding to the assignee's [IRI](#iriDef). | Recommended |
